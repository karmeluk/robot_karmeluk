...
# coordinates generated by laser_list.
# temporary hardcoded
# TODO: add parser from laser_list

#mapa = laser_list.listener()

import subprocess

scanner = subprocess.Popen(["python", ASSETS_DIR + "/laser_list.py"], stdout=subprocess.PIPE)

#print scanner.stdout.read()

# mapa = [[161.2, 51.6], [167.5, 59.0], [159.5, 49.2], [157.0, 63.0], [155.8, 53.6],
...
def index(chartID = 'chart_ID'):
    ...
    return render_template('index.html', chartID=chartID, title=title, subtitle=subtitle, xAxis=xAxis, yAxis=yAxis, legend=legend,\
